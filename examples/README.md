...
1. Copy to your project folder as `docker-compose.yml`
2. Run: `docker compose up -d`
3. Pull a model: `docker exec autonomyx_agentbook-ollama-1 ollama pull mistral`
...
**Use this if:** You're contributing to Autonomyx AgentBook or developing custom features
...
### Add Basic Auth
Add to `autonomyx_agentbook` service environment:
```yaml
