export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Autonomyx AgentBook não pôde ser alcançado",
    ...
    docLink: "Documentação do Autonomyx AgentBook",
  ...
  navigation: {
    ...
    groundedChat: "Chat fundamentado",
    artifacts: "Estúdio de artefatos",
  ...
  workspace: {
    ...
    summaryCards: {
      ...
      notes: "Notas de conhecimento",
      groundedCoverage: "Cobertura de evidências",
      openActions: "Ações em aberto",
    },
    pinnedKnowledge: "Conhecimento fixado",
    pinnedKnowledgeDesc: "Afirmações canônicas confiáveis, revisadas e prontas para reutilização.",
    samplePinned: {
      claim1: "Afirmações sem citações diretas são bloqueadas para publicação.",
      claim2: "Todos os resumos de políticas exigem pelo menos uma fonte atual dos últimos 90 dias.",
    },
    activityTitle: "Atividade recente",
    activityDesc: "Eventos auditáveis para este workspace e seus membros.",
    timelineDesc: "Uma memória contínua de evidências, decisões e resultados.",
    tasksDesc: "Converta insights validados em responsáveis, prazos e aprovações.",
    membersDesc: "Colaboração com escopo por função para fluxos corporativos confiáveis.",
    settingsDesc: "Controles de governança para respostas fundamentadas, citações e rastreabilidade.",
    artifactDesc: "Gere saídas reutilizáveis e fundamentadas em fontes com citações preservadas.",
    artifactPlaceholder: "A estrutura de geração de artefatos está habilitada. Conecte o fluxo de orquestração aos templates de backend para produzir saídas com citações vinculadas.",
    generateArtifact: "Gerar artefato",
    duplicate: "Duplicar workspace",
    activity: {
      sourceAdded: "Nova fonte adicionada a {workspace} e enfileirada para indexação de recuperação.",
      sourceAddedGeneric: "A ingestão da fonte foi concluída e as evidências já estão disponíveis no escopo do chat.",
      noteCaptured: "Nota baseada em evidências capturada e vinculada às referências da fonte.",
      answerSaved: "Resposta fundamentada salva como conhecimento reutilizável do workspace.",
      taskCreated: "Tarefa de ação criada a partir de uma afirmação validada.",
    },
    sampleTasks: {
      task1: "Revisar afirmações não resolvidas com evidências insuficientes",
      task2: "Aprovar briefing executivo para distribuição aos stakeholders",
    },
    settings: {
      audit: "O registro de auditoria é obrigatório para todas as ações relevantes",
      insufficientEvidence: "Respostas com evidências insuficientes são visíveis para todos os membros",
      citationPolicy: "A inspeção de citações permanece ativada para saídas geradas",
    },
  },
  sources: {
    title: "Fontes",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Autonomyx AgentBook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Autonomyx AgentBook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Autonomyx AgentBook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Autonomyx AgentBook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Autonomyx AgentBook.",
