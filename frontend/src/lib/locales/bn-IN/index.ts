export const bnIN = {
  ...
  navigation: {
    ...
    groundedChat: "প্রমাণভিত্তিক চ্যাট",
    artifacts: "আর্টিফ্যাক্ট স্টুডিও",
  ...
  workspace: {
    ...
    summaryCards: {
      sources: "সংযুক্ত উৎস",
      notes: "জ্ঞান নোট",
      groundedCoverage: "প্রমাণ কভারেজ",
      openActions: "খোলা অ্যাকশন",
    },
    pinnedKnowledge: "পিন করা জ্ঞান",
    pinnedKnowledgeDesc: "বিশ্বস্ত, পর্যালোচিত এবং পুনঃব্যবহারের জন্য প্রস্তুত ক্যানোনিক্যাল দাবি।",
    samplePinned: {
      claim1: "সরাসরি উদ্ধৃতি ছাড়া দাবিগুলো প্রকাশে বাধা দেওয়া হবে।",
      claim2: "সব নীতিমালা সারাংশে গত ৯০ দিনের মধ্যে অন্তত একটি বর্তমান উৎস থাকতে হবে।",
    },
    activityTitle: "সাম্প্রতিক কার্যকলাপ",
    activityDesc: "এই ওয়ার্কস্পেস এবং এর সদস্যদের জন্য অডিটযোগ্য ইভেন্ট।",
    timelineDesc: "প্রমাণ, সিদ্ধান্ত এবং ফলাফলের ধারাবাহিক স্মৃতি।",
    tasksDesc: "যাচাইকৃত অন্তর্দৃষ্টিকে মালিক, সময়সীমা এবং অনুমোদনে রূপান্তর করুন।",
    membersDesc: "বিশ্বস্ত এন্টারপ্রাইজ ওয়ার্কফ্লোর জন্য ভূমিকা-সীমাবদ্ধ সহযোগিতা।",
    settingsDesc: "প্রমাণভিত্তিক উত্তর, উদ্ধৃতি এবং ট্রেসেবিলিটির জন্য গভর্ন্যান্স নিয়ন্ত্রণ।",
    artifactDesc: "উদ্ধৃতি অক্ষুণ্ণ রেখে পুনঃব্যবহারযোগ্য, উৎসভিত্তিক আউটপুট তৈরি করুন।",
    artifactPlaceholder: "আর্টিফ্যাক্ট জেনারেশনের কাঠামো সক্রিয় আছে। উদ্ধৃতি-সংযুক্ত আউটপুট তৈরি করতে orchestration workflow-কে backend template-এর সাথে যুক্ত করুন।",
    generateArtifact: "আর্টিফ্যাক্ট তৈরি করুন",
    duplicate: "ওয়ার্কস্পেস ডুপ্লিকেট করুন",
    activity: {
      sourceAdded: "{workspace}-এ নতুন উৎস যোগ করা হয়েছে এবং retrieval indexing-এর জন্য কিউ করা হয়েছে।",
      sourceAddedGeneric: "উৎস ingestion সম্পন্ন হয়েছে এবং এখন চ্যাট scope-এ প্রমাণ উপলব্ধ।",
      noteCaptured: "প্রমাণ-সমর্থিত নোট সংরক্ষিত হয়েছে এবং উৎস রেফারেন্সের সাথে যুক্ত হয়েছে।",
      answerSaved: "প্রমাণভিত্তিক উত্তর পুনঃব্যবহারযোগ্য ওয়ার্কস্পেস জ্ঞান হিসেবে সংরক্ষিত হয়েছে।",
      taskCreated: "যাচাইকৃত দাবির ভিত্তিতে অ্যাকশন টাস্ক তৈরি হয়েছে।",
    },
    sampleTasks: {
      task1: "অপর্যাপ্ত প্রমাণসহ অমীমাংসিত দাবিগুলো পর্যালোচনা করুন",
      task2: "স্টেকহোল্ডারদের মধ্যে বিতরণের জন্য executive brief অনুমোদন করুন",
    },
    settings: {
      audit: "সব গুরুত্বপূর্ণ কাজের জন্য audit logging বাধ্যতামূলক",
      insufficientEvidence: "অপর্যাপ্ত প্রমাণের উত্তর সব সদস্যের কাছে দৃশ্যমান",
      citationPolicy: "জেনারেটেড আউটপুটের জন্য citation inspection চালু থাকবে",
    },
  },
  sources: {
    title: "উৎসগুলি",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Autonomyx AgentBook কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Autonomyx AgentBook এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Autonomyx AgentBook জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া Autonomyx AgentBook সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "Autonomyx AgentBook এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
