export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Autonomyx AgentBook non è raggiungibile",
    ...
    docLink: "Documentazione Autonomyx AgentBook",
  ...
  navigation: {
    ...
    groundedChat: "Chat con fonti",
    artifacts: "Studio artefatti",
  ...
  workspace: {
    ...
    summaryCards: {
      sources: "Fonti collegate",
      notes: "Note di conoscenza",
      groundedCoverage: "Copertura delle evidenze",
      openActions: "Azioni aperte",
    },
    pinnedKnowledge: "Conoscenza fissata",
    pinnedKnowledgeDesc: "Affermazioni canoniche affidabili, revisionate e pronte per il riuso.",
    samplePinned: {
      claim1: "Le affermazioni senza citazioni dirette non possono essere pubblicate.",
      claim2: "Tutti i riepiloghi di policy richiedono almeno una fonte aggiornata degli ultimi 90 giorni.",
    },
    activityTitle: "Attività recenti",
    activityDesc: "Eventi verificabili per questo workspace e i suoi membri.",
    timelineDesc: "Una memoria continua di evidenze, decisioni e risultati.",
    tasksDesc: "Trasforma gli insight validati in responsabili, scadenze e approvazioni.",
    membersDesc: "Collaborazione con ruoli definiti per workflow enterprise affidabili.",
    settingsDesc: "Controlli di governance per risposte fondate, citazioni e tracciabilità.",
    artifactDesc: "Genera output riutilizzabili basati sulle fonti mantenendo le citazioni.",
    artifactPlaceholder: "L'impalcatura per la generazione di artefatti è abilitata. Collega il workflow di orchestrazione ai template backend per produrre output con citazioni collegate.",
    generateArtifact: "Genera artefatto",
    duplicate: "Duplica workspace",
    activity: {
      sourceAdded: "Nuova fonte aggiunta a {workspace} e messa in coda per l'indicizzazione di recupero.",
      sourceAddedGeneric: "L'ingestione della fonte è completata e le evidenze sono ora disponibili nel perimetro della chat.",
      noteCaptured: "Nota supportata da evidenze acquisita e collegata ai riferimenti della fonte.",
      answerSaved: "Risposta fondata salvata come conoscenza riutilizzabile del workspace.",
      taskCreated: "Attività creata a partire da un'affermazione validata.",
    },
    sampleTasks: {
      task1: "Rivedere le affermazioni irrisolte con evidenze insufficienti",
      task2: "Approvare il brief esecutivo per la distribuzione agli stakeholder",
    },
    settings: {
      audit: "Il logging di audit è obbligatorio per tutte le azioni rilevanti",
      insufficientEvidence: "Le risposte con evidenze insufficienti sono visibili a tutti i membri",
      citationPolicy: "L'ispezione delle citazioni resta abilitata per gli output generati",
    },
  },
  sources: {
    title: "Fonti",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Autonomyx AgentBook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Autonomyx AgentBook.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Autonomyx AgentBook",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Autonomyx AgentBook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Autonomyx AgentBook.",
