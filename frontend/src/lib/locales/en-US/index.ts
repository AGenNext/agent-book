export const enUS = {
  common: {
    ...
    accessibility: {
      ...
      searchNotebooks: "Search workspaces",
    },
    url: "URL",
  ...
  connectionErrors: {
    ...
    apiDesc: "The AgentBook API server could not be reached",
    ...
    docLink: "Autonomyx AgentBook Documentation",
  ...
  workspace: {
    ...
    summaryCards: {
      ...
      groundedCoverage: "Evidence coverage",
      openActions: "Open actions",
    },
    pinnedKnowledge: "Pinned knowledge",
    pinnedKnowledgeDesc: "Canonical claims that are trusted, reviewed, and ready for reuse.",
    samplePinned: {
      claim1: "Claims without direct citations are blocked from publishing.",
      claim2: "All policy summaries require at least one current source from the last 90 days.",
    },
    activityTitle: "Recent activity",
    activityDesc: "Auditable events for this workspace and its members.",
    timelineDesc: "A continuous memory of evidence, decisions, and outcomes.",
    tasksDesc: "Convert validated insights into owners, due dates, and approvals.",
    membersDesc: "Role-scoped collaboration for trusted enterprise workflows.",
    settingsDesc: "Governance controls for grounded answers, citations, and traceability.",
    artifactDesc: "Generate reusable, source-grounded outputs with citations preserved.",
    artifactPlaceholder: "Artifact generation scaffolding enabled. Connect orchestration workflow to backend templates to produce citation-linked outputs.",
    generateArtifact: "Generate artifact",
    duplicate: "Duplicate workspace",
    activity: {
      sourceAdded: "New source added to {workspace} and queued for retrieval indexing.",
      sourceAddedGeneric: "Source ingestion completed and evidence is now available in chat scope.",
      noteCaptured: "Evidence-backed note captured and linked to source references.",
      answerSaved: "Grounded answer saved as reusable workspace knowledge.",
      taskCreated: "Action task created from a validated claim.",
    },
    sampleTasks: {
      task1: "Review unresolved claims with insufficient evidence",
      task2: "Approve executive brief for stakeholder distribution",
    },
    settings: {
      audit: "Audit logging is required for all material actions",
      insufficientEvidence: "Insufficient evidence responses are visible to all members",
      citationPolicy: "Citation inspection remains enabled for generated outputs",
    },
  },
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Autonomyx AgentBook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Autonomyx AgentBook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Autonomyx AgentBook",
    missingRequiredModels: "Missing required models: {models}. Autonomyx AgentBook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Autonomyx AgentBook.",
