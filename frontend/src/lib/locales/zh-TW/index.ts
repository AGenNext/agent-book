export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Autonomyx AgentBook API 伺服器",
    dbTitle: "資料庫連線失敗",
    ...
    docLink: "Autonomyx AgentBook 文件",
  ...
  workspace: {
    ...
    summaryCards: {
      sources: "已連接來源",
      notes: "知識筆記",
      groundedCoverage: "證據覆蓋率",
      openActions: "待處理事項",
    },
    pinnedKnowledge: "置頂知識",
    pinnedKnowledgeDesc: "可信、已審閱且可重複使用的規範性結論。",
    samplePinned: {
      claim1: "沒有直接引用的結論將被阻止發佈。",
      claim2: "所有政策摘要都至少需要一條最近 90 天內的當前來源。",
    },
    activityTitle: "最近活動",
    activityDesc: "此工作區及其成員的可審計事件。",
    timelineDesc: "關於證據、決策與結果的連續記錄。",
    tasksDesc: "將已驗證的洞察轉化為負責人、截止日期與審批。",
    membersDesc: "面向可信企業工作流程的角色範圍協作。",
    settingsDesc: "針對有據可依回答、引用與可追溯性的治理控制。",
    artifactDesc: "生成可重用且保留引用的基於來源輸出。",
    artifactPlaceholder: "產物生成功能框架已啟用。將協調工作流程連接到後端範本以產生附引用連結的輸出。",
    generateArtifact: "生成產物",
    duplicate: "複製工作區",
    activity: {
      sourceAdded: "新來源已新增到 {workspace}，並排入檢索索引佇列。",
      sourceAddedGeneric: "來源匯入已完成，證據現在可在聊天範圍內使用。",
      noteCaptured: "已擷取基於證據的筆記並連結到來源引用。",
      answerSaved: "基於證據的回答已儲存為可重用的工作區知識。",
      taskCreated: "已從已驗證結論建立行動任務。",
    },
    sampleTasks: {
      task1: "審查證據不足的未解決結論",
      task2: "核准供利害關係人分發的高層簡報",
    },
    settings: {
      audit: "所有重要操作都必須啟用稽核日誌",
      insufficientEvidence: "證據不足的回答對所有成員可見",
      citationPolicy: "生成輸出時仍啟用引用檢視",
    },
  },
  sources: {
    title: "來源",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Autonomyx AgentBook 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Autonomyx AgentBook 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Autonomyx AgentBook 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Autonomyx AgentBook 中啟用 AI 服務商。",
