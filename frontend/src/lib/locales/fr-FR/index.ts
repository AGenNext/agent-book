export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Autonomyx AgentBook est injoignable",
    ...
    docLink: "Documentation de Autonomyx AgentBook",
  ...
  auth: {
    loginTitle: "Autonomyx AgentBook",
  ...
  navigation: {
    ...
    groundedChat: "Chat fondé sur les sources",
    artifacts: "Studio d'artefacts",
  ...
  workspace: {
    ...
    summaryCards: {
      sources: "Sources connectées",
      notes: "Notes de connaissance",
      groundedCoverage: "Couverture des preuves",
      openActions: "Actions ouvertes",
    },
    pinnedKnowledge: "Connaissances épinglées",
    pinnedKnowledgeDesc: "Assertions canoniques fiables, relues et prêtes à être réutilisées.",
    samplePinned: {
      claim1: "Les affirmations sans citations directes sont bloquées avant publication.",
      claim2: "Tous les résumés de politique exigent au moins une source actuelle datant des 90 derniers jours.",
    },
    activityTitle: "Activité récente",
    activityDesc: "Événements auditables pour cet espace de travail et ses membres.",
    timelineDesc: "Une mémoire continue des preuves, décisions et résultats.",
    tasksDesc: "Transformez les insights validés en responsables, échéances et approbations.",
    membersDesc: "Collaboration par rôle pour des workflows d'entreprise fiables.",
    settingsDesc: "Contrôles de gouvernance pour les réponses sourcées, les citations et la traçabilité.",
    artifactDesc: "Générez des livrables réutilisables fondés sur les sources tout en conservant les citations.",
    artifactPlaceholder: "L'ossature de génération d'artefacts est activée. Reliez le workflow d'orchestration aux modèles backend pour produire des sorties avec citations liées.",
    generateArtifact: "Générer un artefact",
    duplicate: "Dupliquer l'espace de travail",
    activity: {
      sourceAdded: "Nouvelle source ajoutée à {workspace} et mise en file pour l'indexation de recherche.",
      sourceAddedGeneric: "L'ingestion de la source est terminée et les preuves sont maintenant disponibles dans le périmètre du chat.",
      noteCaptured: "Note appuyée par des preuves capturée et liée aux références source.",
      answerSaved: "Réponse fondée sur les preuves enregistrée comme connaissance réutilisable de l'espace de travail.",
      taskCreated: "Tâche créée à partir d'une affirmation validée.",
    },
    sampleTasks: {
      task1: "Examiner les affirmations non résolues avec preuves insuffisantes",
      task2: "Approuver la note exécutive pour diffusion aux parties prenantes",
    },
    settings: {
      audit: "La journalisation d'audit est requise pour toutes les actions importantes",
      insufficientEvidence: "Les réponses avec preuves insuffisantes sont visibles par tous les membres",
      citationPolicy: "L'inspection des citations reste activée pour les sorties générées",
    },
  },
  sources: {
    title: "Sources",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Autonomyx AgentBook à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Autonomyx AgentBook est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Autonomyx AgentBook",
    missingRequiredModels: "Modèles requis manquants : {models}. Autonomyx AgentBook pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Autonomyx AgentBook.",
