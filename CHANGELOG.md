...
- **Security Enhancements**
  ...
  - Default password "autonomyx-agentbook-change-me" for out-of-box experience (change in production!)
...
- New utility modules: `chunking.py` and `embedding.py` in `autonomyx_agentbook/utils/`
