...
- **Security Enhancements**
  ...
  - Default password "agentbook-change-me" for out-of-box experience (change in production!)
...
- New utility modules: `chunking.py` and `embedding.py` in `agentbook/utils/`
