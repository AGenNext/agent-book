...
A flexible and generic ContextBuilder class for the Autonomyx AgentBook project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
The ContextBuilder integrates seamlessly with the existing Autonomyx AgentBook architecture:
