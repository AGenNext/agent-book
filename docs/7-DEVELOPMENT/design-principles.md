...
This document outlines the core principles, vision, and design philosophy that guide Autonomyx AgentBook's development. All contributors should read and understand these principles before proposing changes or new features.

## 🎯 Project Vision

Autonomyx AgentBook aims to be a **privacy-focused, self-hosted alternative to Google NotebookLM** that empowers users to:
...
### What Autonomyx AgentBook IS NOT
