...
- **Frontend**: http://localhost:3000 → AgentBook UI
...
- **First Issue?** Pick a [good first issue](https://github.com/agentnxt/agentbook/issues?q=label%3A%22good+first+issue%22)
