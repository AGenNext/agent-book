...
Get Autonomyx AgentBook running locally in 5 minutes.
...
- **Frontend**: http://localhost:3000 → Autonomyx AgentBook UI
...
- **First Issue?** Pick a [good first issue](https://github.com/autonomyx/agentbook/issues?q=label%3A%22good+first+issue%22)
