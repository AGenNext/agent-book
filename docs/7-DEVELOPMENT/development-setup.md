...
This guide walks you through setting up Autonomyx AgentBook for local development. Follow these steps to get the full stack running on your machine.
...
uv run pytest --cov=autonomyx_agentbook --cov-report=html
```
