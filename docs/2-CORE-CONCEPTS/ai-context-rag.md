# AI Context & RAG - How Autonomyx AgentBook Uses Your Research

Autonomyx AgentBook uses different approaches to make AI models aware of your research depending on the feature. This section explains **RAG** (used in Ask) and **full-content context** (used in Chat).
...
### Autonomyx AgentBook's Dual Approach
...
When you upload a source, Autonomyx AgentBook prepares it for retrieval:
...
Autonomyx AgentBook provides two different search strategies for different goals.
...
Here's where Autonomyx AgentBook is different: **You decide what the AI sees.**
...
Autonomyx AgentBook's RAG approach gives you something you don't get with ChatGPT or Claude directly:
...
Autonomyx AgentBook gives you **two ways** to work with AI:
