...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Autonomyx AgentBook
...
### Step 4: Configure Autonomyx AgentBook
...
```yaml
# In your Autonomyx AgentBook docker-compose.yml
environment:
...
### Step 5: Add Model in Autonomyx AgentBook
...
### Autonomyx AgentBook in Docker (macOS/Windows)

**TTS Base URL:** `http://host.docker.internal:8969/v1`

### Autonomyx AgentBook in Docker (Linux)
...
# From inside Autonomyx AgentBook container
docker exec -it autonomyx-agentbook curl http://host.docker.internal:8969/v1/models
```
