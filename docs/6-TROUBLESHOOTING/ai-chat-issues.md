...
# The model name in Autonomyx AgentBook must be EXACTLY "gemma3:12b"
...
> **Tip:** This error often occurs when you delete a model from Ollama but forget to update the default models in Autonomyx AgentBook. Always re-configure defaults after removing models.
