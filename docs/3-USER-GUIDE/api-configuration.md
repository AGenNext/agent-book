...
> **Credential System**: Autonomyx AgentBook uses encrypted credentials stored in the database. Each credential connects to a provider and allows you to discover, register, and test models.

---

## Overview

Autonomyx AgentBook manages AI provider access through a **credential-based system**:
...
3. The models are now available throughout Autonomyx AgentBook
...
|---------|---------------|---------------------------|
| Password | `autonomyx-agentbook-change-me` | Set `OPEN_NOTEBOOK_PASSWORD` |
